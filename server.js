...
app.get('/api/chart', async (req, res) => {
  ...
  try {
    ...
    if (!series) {
      console.log('AV response:', JSON.stringify(data).slice(0, 200));
      return res.json({ dates: [], closes: [] });
    }
